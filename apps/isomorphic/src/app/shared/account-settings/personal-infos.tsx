  ...
  return (
    <div className='w-full'>
      ...
      <div className='w-full mt-6'>
        <div className='w-full flex items-center py-4 relative before:absolute before:w-full before:h-px before:bg-slate-300 before:bottom-0'>
          <div className='w-[30%]'>
